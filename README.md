...
2. **[InformationSystem](src/InformationSystem)**  
...
3. **[ObjectOrientedPractics](src/ObjectOrientedPractics)**  
...
- [**Windows Forms**](https://learn.microsoft.com/en-us/dotnet/desktop/winforms/?view=netdesktop-9.0) – An open-source framework for building rich Windows desktop applications with native controls.
- [**WPF (.NET)**](https://learn.microsoft.com/en-us/dotnet/desktop/wpf/?view=netdesktop-9.0) – A UI framework for creating visually stunning, scalable desktop applications using XAML and advanced graphics capabilities.
